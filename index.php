...
<html  dir="ltr" lang="en" xml:lang="en">
    ...
    <body  id="page-site-index" class="format-site course path-site safari dir-ltr lang-en yui-skin-sam yui3-skin-sam mycodebusters-com--lms pagelayout-frontpage course-1 context-2 notloggedin two-column has-region-side-pre used-region-side-pre has-region-side-post used-region-side-post has-region-footer-left empty-region-footer-left has-region-footer-middle empty-region-footer-middle has-region-footer-right empty-region-footer-right has-region-hidden-dock empty-region-hidden-dock">
        ...
        <script type="text/javascript" src="http://mycodebusters.com/lms/theme/yui_combo.php?rollup/3.17.2/yui-moodlesimple-min.js&amp;rollup/1481653553/mcore-min.js"></script><script type="text/javascript" src="http://mycodebusters.com/lms/theme/jquery.php/core/jquery-1.11.3.min.js"></script>
        <script type="text/javascript" src="http://mycodebusters.com/lms/theme/jquery.php/theme_lambda/jquery.easing.1.3.js"></script>
        <script type="text/javascript" src="http://mycodebusters.com/lms/theme/jquery.php/theme_lambda/camera.min.js"></script>
        <script type="text/javascript" src="http://mycodebusters.com/lms/theme/jquery.php/theme_lambda/jquery.bxslider.js"></script>
        <script type="text/javascript" src="http://mycodebusters.com/lms/lib/javascript.php/1481653553/lib/javascript-static.js"></script>
        <script type="text/javascript">
            //<![CDATA[
        ...
        <div id="wrapper">
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="span6 login-header">
                            <div class="profileblock">
                                ...
                                <!-- 
                                <form class="navbar-form pull-right" method="post" action="http://mycodebusters.com/lms/login/index.php?authldap_skipntlmsso=1">
                                    <div id="block-login">
                                    ...
                                    <div class="forgotpass">
                                        <a target="_self" href="http://mycodebusters.com/lms/login/forgot_password.php">Forgotten your username or password?</a>
            ...
            <header role="banner" class="navbar">
                <nav role="navigation" class="navbar-inner">
                    <div class="container-fluid">
                        <a class="brand" href="http://mycodebusters.com/lms">Home</a>            
                                            ...
                                            <div class="no-overflow" id="yui_3_17_2_1_1481703191444_133">
                                                <div class="row-fluid frontpage" id="yui_3_17_2_1_1481703191444_132">
                                                    <div class="span6" id="yui_3_17_2_1_1481703191444_141">
                                                        <img src="http://lambda.redpithemes.com/pluginfile.php/378/mod_label/intro/lambda_responsive.jpg" alt="lambda responsive" class="img-responsive" id="yui_3_17_2_1_1481703191444_140"></div>
                                                    <div class="span6" id="yui_3_17_2_1_1481703191444_131">
                                                        ...
                                                        <form class="navbar-form" method="post" action="http://mycodebusters.com/lms/login/index.php?authldap_skipntlmsso=1">
                                                            ...
                                                            <div class="forgotpass" style="padding-left:35px;">
                                                                <a style="" target="_self" href="http://mycodebusters.com/lms/login/forgot_password.php">Forgotten your username or password?</a>
                                                            </div>
            ...
            <script type="text/javascript">
                //<![CDATA[
                var require = {
                baseUrl : 'http://mycodebusters.com/lms/lib/requirejs.php/1481653553/',
                        // We only support AMD modules with an explicit define() statement.
                        enforceDefine: true,
                        skipDataMain: true,
                        paths: {
                        jquery: 'http://mycodebusters.com/lms/lib/javascript.php/1481653553/lib/jquery/jquery-1.11.3.min',
                                jqueryui: 'http://mycodebusters.com/lms/lib/javascript.php/1481653553/lib/jquery/ui-1.11.4/jquery-ui.min',
                                jqueryprivate: 'http://mycodebusters.com/lms/lib/javascript.php/1481653553/lib/requirejs/jquery-private'
                        },
            ...
            <script type="text/javascript" src="http://mycodebusters.com/lms/lib/javascript.php/1481653553/lib/requirejs/require.min.js"></script>
            <script type="text/javascript">
                //<![CDATA[
            ...
            <script type="text/javascript" src="http://mycodebusters.com/lms/theme/javascript.php/lambda/1481704169/footer"></script>
            <script type="text/javascript">
                //<![CDATA[
            ...
            <!--[if lte IE 9]>
            <script src="http://mycodebusters.com/lms/theme/lambda/javascript/ie/iefix.js"></script>
            <![endif]-->
